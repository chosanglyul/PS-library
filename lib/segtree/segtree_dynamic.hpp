...
class SegtreeDynamic {
    private:
    const index_t n;
    static const unsigned int MAX = __UINT32_MAX__;
    struct Node {
        unsigned int l, r;
    ...
    void update(const unsigned int i, const index_t s, const index_t e, const index_t j, const node_query &x) {
    ...
    node_seg query(const unsigned int i, const index_t s, const index_t e, const index_t l, const index_t r) const {
    ...
    public:
    SegtreeDynamic(index_t n) : n(n) { seg = {Node::inf()}; }
